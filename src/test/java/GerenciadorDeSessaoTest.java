...
public class GerenciadorDeSessaoTest {
	...
	public void preparaSessoes() {
	    ...
	    this.rogueOne = new Filme("Rogue One", Duration.ofMinutes(121), "SCI-FI", BigDecimal.ONE);
	    this.sala3D = new Sala("Sala 3D", BigDecimal.TEN);
	    
	    this.sessaoDasDez = new Sessao(LocalTime.parse("10:00:00"), rogueOne, sala3D);
	    this.sessaoDasTreze = new Sessao(LocalTime.parse("11:00:00"), rogueOne, sala3D);
	    this.sessaoDasDezoito = new Sessao(LocalTime.parse("23:30:00"), rogueOne, sala3D);
	}
